...
public class DensityUtils {
    ...
    public static int sp2px(float spValue) {
        final float fontScale = MyApplication.instance.getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int getViewId(String idStr) {
        return MyApplication.instance.getResources().getIdentifier(idStr, "id", MyApplication.instance.getPackageName());
    }

    public static int getDrawableId(String idStr) {
        return MyApplication.instance.getResources().getIdentifier(idStr, "drawable", MyApplication.instance.getPackageName());
    }
    ...
    public static int getTotalHeightofListView(ListView listView) {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            LogUtil.log(  String.valueOf(mView.getMeasuredHeight()));
        }
