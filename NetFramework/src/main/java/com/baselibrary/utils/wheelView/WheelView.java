...
package com.baselibrary.utils.wheelView;
...
import com.baselibrary.utils.wheelView.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.color_c7));
		// 设置线宽
